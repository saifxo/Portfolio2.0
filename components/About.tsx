...
function About({pageInfo}: Props) {
  return (
    ...
    className='flex relative  flex-col h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        className='-mb-20 md:mb-0 mt-6 flex-shrink-0 text-center w-44 h-44 rounded-full object-cover object-top md:rounded-lg md:w-64 md:h-96  lg:w-[400px] lg:h-[500px]'
        alt='myaboutimg'
        />
